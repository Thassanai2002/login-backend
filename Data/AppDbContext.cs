...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(u => u.Id).HasColumnName("id").HasDefaultValueSql("uuid()");
            ...
            entity.Property(u => u.CreatedDate).HasColumnName("createdDate").HasDefaultValueSql("utc_timestamp()");
